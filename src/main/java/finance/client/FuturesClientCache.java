...
public final class FuturesClientCache{
    ...
    public static Entry get(){if(entry.state()==State.LOADING&&System.currentTimeMillis()-entry.requestedAt()>3000)entry=new Entry(State.SLOW,entry.requestId(),entry.requestedAt(),null);return entry;}
